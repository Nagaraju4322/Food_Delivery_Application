...
%>
	...
	<section class="popular-section" id="fooditems">
		...
		<div class="items">
			...
			<% } %>
				<div class="item-card">
					<img src="https://madhurasrecipe.com/wp-content/uploads/2021/10/idli_premix_featured.jpg"
						alt="Soft Idly" />
					<h3>Soft Idly</h3>
					<p>⭐️⭐️⭐️⭐️☆</p>
					<p>Price ₹80</p>
			...
			<% } %>
				<div class="item-card">
					<img src="https://s.lightorangebean.com/media/20240914160809/Spicy-Penne-Pasta_-done.png"
						alt="Masala Dosa" />
					<h3>Pasta</h3>
					<p>⭐️⭐️⭐️⭐️⭐</p>
					<p>Price ₹150</p>
			...
			<% } %>
				<div class="item-card">
					<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWRik6sFuVklzgD7m3JJ8GwTboDP3m4BL8eA&s"
						alt="Masala Dosa" />
					<h3>Shawarma</h3>
					<p>⭐️⭐️⭐️⭐⭐</p>
					<p>Price ₹150</p>
	...
	<section class="offers-section" id="offers">
		...
		<div class="offers-grid">
			<div class="offer-card">
				<img
					src="https://i.pinimg.com/736x/88/7e/e9/887ee9373910df68bcf5bcd0bb88b5f8.jpg"
					alt="Pizza Offer" />
			...
			<div class="offer-card">
				<img
					src="https://img.freepik.com/premium-psd/delicious-burger-food-social-media-promotion-instagram-banner-post-design-template_1145094-881.jpg?semt=ais_hybrid&w=740&q=80"
					alt="Burger Offer" />
			...
			<div class="offer-card">
				<img
					src="https://www.shutterstock.com/image-photo/create-feel-good-scene-monsoon-600nw-2631476239.jpg"
					alt="Chai Offer" />
